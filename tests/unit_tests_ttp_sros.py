...
class TestSrosParser(unittest.TestCase):
    example_config = "configs/example-config.txt"

    def test_templates_as_list(self):
        """
        Test to ensure all templates are imported as a list.
        """
        data = "simple text to instantiate class."
        parser = SrosParser(data)
        self.assertIs(type(parser.get_all_templates()), list)

    def test_get_router_interfaces(self):
        """
        Test to ensure interfaces are extracted from the base context.
        """
        # this aint working
        parser = SrosParser(self.example_config)
...
#     }
# ]"""
#         self.assertEqual(result, system_interface)
...
#     }
# ]"""
#         self.assertEqual(result, system_configuration)
...
#     def test_get_system_hostname(self):
#         """
#         Test extracting hostname only.
#         """
#         parser = SrosParser(self.example_config)
#         result = parser.get_system_hostname()
#         self.assertEqual(result, "EXAMPLEPHX-P-AL-7750-01")

#     def test_get_show_bof(self):
#         """
...
#     }
# ]"""
#         self.assertEqual(result, bof)

#     def test_get_system_cards(self):
#         """
#         Test extracting hostname only.
#         """
#         parser = SrosParser(self.example_config)
...
#     }
# ]"""
#         self.assertEqual(result, maf)

#     def test_get_system_ethcfm(self):
#         """
...
#     }
# ]"""
#         self.assertEqual(result, ethcfm)
...
#     def test_get_system_service_sdp(self):
#         """
...
#     }
# ]"""
#         self.assertEqual(result, sdp)

#     def test_get_router_static_routes(self):
#         """
...
#     def test_show_router_interface(self):
#         """
...
#     }
# ]"""
#         self.assertEqual(result, filedir)
        
#     def test_show_service_service_using(self):
...
#     def test_show_router_static_route_tag_ipv4(self):
...
#     }
# ]"""
#         self.assertEqual(result, ipv4_routes)

#     def test_show_router_static_route_tag_ipv6(self):
...
#     }
# ]"""
#         self.assertEqual(result, ipv6_result)

#     def test_show_router_route_table(self):
