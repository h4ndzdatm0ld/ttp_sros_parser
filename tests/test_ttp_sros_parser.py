...
#     assertEqual(result, "EXAMPLEPHX-P-AL-7750-01")
...
# }
# ]"""
#     assertEqual(result, ipv4_routes)
...
# }
# ]"""
    # assertEqual(result, ipv6_result)
